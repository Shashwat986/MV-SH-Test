...
This is the second paragraph`},nv=OE("config",{persist:!0,state:()=>JSON.parse(JSON.stringify(tv))}),$P={class:"container"},BP={class:"columns"},HP={class:"column is-6"},VP={class:"tabs is-centered"},jP=["onClick"],WP=C("h1",{class:"title is-5"}," SuperHome My Products Card Builder ",-1),zP=C("h2",{class:"subtitle is-6"},' Here, you can play around with text lengths and copy for creating "My Products" cards. The first card on the right-hand side will change instanteously to show the current scenario. Additionally, you can choose from the 3 configurations using the tabs above. When you click on "Save" at the bottom of the screen, the card is saved. You can see all saved card for that specific product on this page, but the entire list of saved cards is visible in the "Browse" section. ',-1),KP={class:"field"},qP=C("label",{class:"label"},"Product Name",-1),GP={class:"control is-expanded"},YP={class:"field"},XP=C("label",{class:"label"},"Primary Field",-1),QP={class:"field has-addons"},JP={class:"control"},ZP={class:"select"},eN=C("option",{value:!1},null,-1),tN=C("option",{value:!0},"₹",-1),nN=[eN,tN],iN={class:"control is-expanded"},sN={class:"field"},rN=["disabled"],oN=["disabled"],lN=C("hr",null,null,-1),aN={key:0,class:"field is-horizontal"},cN={class:"field-body"},uN={class:"field"},hN=C("label",{class:"label"},"Secondary Field Title",-1),fN={class:"control"},dN={class:"field"},pN=C("label",{class:"label"},"Secondary Field Value",-1),gN={class:"control"},_N={class:"field"},mN=C("label",{class:"label"},"Status",-1),vN={class:"control"},yN={class:"radio"},EN={class:"radio"},wN={class:"radio"},CN={class:"field is-horizontal"},IN={class:"field-body"},TN={class:"field"},bN=C("label",{class:"label"},"Message",-1),SN={class:"control"},RN={class:"field"},AN=C("label",{class:"label"},"CTA Text",-1),PN={class:"control"},NN={key:2,class:"field is-horizontal"},kN={class:"field-body"},ON={class:"field"},xN=C("label",{class:"label"},"Third Field?",-1),DN={class:"control"},MN={class:"radio"},LN={class:"radio"},FN={class:"radio"},UN={class:"field"},$N=C("label",{class:"label"},"Third Field Value",-1),BN={class:"control"},HN=["disabled"],VN={key:3,class:"field"},jN=C("label",{class:"label"},"Message",-1),WN={class:"control"},zN={class:"buttons"},KN={class:"column is-6"},qN={class:"main"},GN=C("div",{class:"header"}," My Products ",-1),YN={key:0,class:"header mt-5"},XN={key:1,class:"button is-loading is-fullwidth"},QN=["onClick"],Id={__name:"HomeView",setup(t){const e=sP(),n=iP(),i=Bm(Sn.ref("/cards")),s=Hm(Sn.ref("/status")),r=nv(),o=me(["Data Points","Data + CTA","Message"]);function l(){r.$patch(tv),n.push("/")}function a(){let p=["type","product_name","rupee","primary_field","notif_dot"].concat({"Data Points":["heading_2","field_2","third_field_type","field_3"],"Data + CTA":["message_2","field_cta","c2_color"],Message:["message"]}[r.type]),_={};return p.forEach(v=>{_[v]=r[v]}),_.type=="Data + CTA"&&["orange","red"].includes(_.c2_color)&&(_.notif_dot=!1),_}function c(){a(),console.log(JSON.stringify(a())),e.params.id?Sn.set(`/cards/${e.params.id}`,a()):Sn.push("/cards",a())}function u(p){return i.value.filter(_=>_.product_name.toLowerCase()==p.toLowerCase())}function h(p){Sn.del(`/cards/${p}`),n.push("/")}function f(p){r.$patch(p),n.push(`/edit/${p.id}`)}return(p,_)=>(z(),Q("div",$P,[C("div",BP,[C("div",HP,[C("div",VP,[C("ul",null,[(z(!0),Q(ke,null,Ui(o.value,v=>(z(),Q("li",{class:Mn({"is-active":D(r).type==v}),onClick:b=>{D(r).type=v,D(r).type=v}},[C("a",null,ln(v),1)],10,jP))),256))])]),WP,zP,C("div",KP,[qP,C("div",GP,[Ye(C("input",{class:"input",type:"text","onUpdate:modelValue":_[0]||(_[0]=v=>D(r).product_name=v)},null,512),[[En,D(r).product_name]])])]),C("div",YP,[XP,C("div",QP,[C("p",JP,[C("span",ZP,[Ye(C("select",{"onUpdate:modelValue":_[1]||(_[1]=v=>D(r).rupee=v)},nN,512),[[mE,D(r).rupee]])])]),C("div",iN,[Ye(C("input",{class:"input",type:"text","onUpdate:modelValue":_[2]||(_[2]=v=>D(r).primary_field=v)},null,512),[[En,D(r).primary_field]])])])]),C("div",sN,[C("label",{class:"checkbox label",disabled:D(r).type=="Data + CTA"&&(D(r).c2_color=="orange"||D(r).c2_color=="red")},[Ye(C("input",{type:"checkbox","onUpdate:modelValue":_[3]||(_[3]=v=>D(r).notif_dot=v),disabled:D(r).type=="Data + CTA"&&(D(r).c2_color=="orange"||D(r).c2_color=="red")},null,8,oN),[[_E,D(r).notif_dot]]),Et(" Notification Dot? ")],8,rN)]),lN,D(r).type=="Data Points"?(z(),Q("div",aN,[C("div",cN,[C("div",uN,[hN,C("div",fN,[Ye(C("input",{class:"input",type:"text","onUpdate:modelValue":_[4]||(_[4]=v=>D(r).heading_2=v)},null,512),[[En,D(r).heading_2]])])]),C("div",dN,[pN,C("div",gN,[Ye(C("input",{class:"input",type:"text","onUpdate:modelValue":_[5]||(_[5]=v=>D(r).field_2=v)},null,512),[[En,D(r).field_2]])])])])])):Oe("",!0),D(r).type=="Data + CTA"?(z(),Q(ke,{key:1},[C("div",_N,[mN,C("div",vN,[C("label",yN,[Ye(C("input",{type:"radio","onUpdate:modelValue":_[6]||(_[6]=v=>D(r).c2_color=v),value:"green"},null,512),[[yi,D(r).c2_color]]),Et(" Green ")]),C("label",EN,[Ye(C("input",{type:"radio","onUpdate:modelValue":_[7]||(_[7]=v=>D(r).c2_color=v),value:"orange"},null,512),[[yi,D(r).c2_color]]),Et(" Orange ")]),C("label",wN,[Ye(C("input",{type:"radio","onUpdate:modelValue":_[8]||(_[8]=v=>D(r).c2_color=v),value:"red"},null,512),[[yi,D(r).c2_color]]),Et(" Red ")])])]),C("div",CN,[C("div",IN,[C("div",TN,[bN,C("div",SN,[Ye(C("textarea",{class:"textarea","onUpdate:modelValue":_[9]||(_[9]=v=>D(r).message_2=v),rows:"2"},null,512),[[En,D(r).message_2]])])]),C("div",RN,[AN,C("div",PN,[Ye(C("input",{class:"input",type:"text","onUpdate:modelValue":_[10]||(_[10]=v=>D(r).field_cta=v)},null,512),[[En,D(r).field_cta]])])])])])],64)):Oe("",!0),D(r).type=="Data Points"?(z(),Q("div",NN,[C("div",kN,[C("div",ON,[xN,C("div",DN,[C("label",MN,[Ye(C("input",{type:"radio","onUpdate:modelValue":_[11]||(_[11]=v=>D(r).third_field_type=v),value:null},null,512),[[yi,D(r).third_field_type]]),Et(" No ")]),C("label",LN,[Ye(C("input",{type:"radio","onUpdate:modelValue":_[12]||(_[12]=v=>D(r).third_field_type=v),value:"Top"},null,512),[[yi,D(r).third_field_type]]),Et(" On Top ")]),C("label",FN,[Ye(C("input",{type:"radio","onUpdate:modelValue":_[13]||(_[13]=v=>D(r).third_field_type=v),value:"Bottom"},null,512),[[yi,D(r).third_field_type]]),Et(" On Bottom ")])])]),C("div",UN,[$N,C("div",BN,[Ye(C("input",{class:"input",type:"text","onUpdate:modelValue":_[14]||(_[14]=v=>D(r).field_3=v),disabled:!D(r).third_field_type},null,8,HN),[[En,D(r).field_3]])])])])])):Oe("",!0),D(r).type=="Message"?(z(),Q("div",VN,[jN,C("div",WN,[Ye(C("textarea",{class:"textarea","onUpdate:modelValue":_[15]||(_[15]=v=>D(r).message=v),placeholder:"e.g. Hello world",rows:"2"},null,512),[[En,D(r).message]])])])):Oe("",!0),C("div",zN,[D(e).params.id?Oe("",!0):(z(),Q("button",{key:0,class:"button is-primary is-fullwidth",onClick:c},"Save")),D(e).params.id?(z(),Q("button",{key:1,class:"button is-warning is-fullwidth",onClick:c},"Update")):Oe("",!0),D(e).params.id?(z(),Q("button",{key:2,class:"button is-outlined is-danger is-fullwidth",onClick:_[16]||(_[16]=v=>h(D(e).params.id))},"Delete")):Oe("",!0),C("button",{class:"button is-default text-right",onClick:_[17]||(_[17]=v=>l())},"Reset")])]),C("div",KN,[C("main",qN,[GN,C("div",{onClick:_[18]||(_[18]=v=>D(n).push("/"))},[Re(rc,{config:D(r)},null,8,["config"])]),u(D(r).product_name).length>0?(z(),Q("div",YN," Saved Cards ")):Oe("",!0),D(s)?Oe("",!0):(z(),Q("button",XN,"Loading")),(z(!0),Q(ke,null,Ui(u(D(r).product_name),v=>(z(),Q("div",{onClick:b=>f(v)},[Re(rc,{config:v},null,8,["config"])],8,QN))),256))])])])]))}},JN={class:"container"},ZN={key:0,class:"columns is-multiline"},e1={class:"column is-4"},t1={class:"main browse"},n1={class:"header mt-5"},i1={key:0,class:"button is-loading is-fullwidth"},s1=["onClick"],r1=["onClick"],o1={key:1,class:"button is-loading is-fullwidth"},l1={__name:"BrowseView",setup(t){const e=nv(),n=Bm(Sn.ref("/cards")),i=Hm(Sn.ref("/status"));function s(a){return n.value.filter(c=>c.product_name.toLowerCase()==a.toLowerCase())}function r(){let a=[];return n.value.forEach(c=>{a.includes(c.product_name.toLowerCase())||a.push(c.product_name.toLowerCase())}),a}function o(a){Sn.del(`/cards/${a}`)}function l(a){e.$patch(a),iv.push(`/edit/${a.id}`)}return(a,c)=>(z(),Q("div",JN,[D(i)?(z(),Q("div",ZN,[(z(!0),Q(ke,null,Ui(r(),u=>(z(),Q("div",e1,[C("main",t1,[C("div",n1," My Products ("+ln(u)+") ",1),D(i)?Oe("",!0):(z(),Q("button",i1,"Loading")),(z(!0),Q(ke,null,Ui(s(u),h=>(z(),Q("div",{onClick:f=>l(h),style:{position:"relative"}},[C("button",{class:"button is-danger close",onClick:EE(f=>o(h.id),["stop"])}," x ",8,r1),Re(rc,{config:h},null,8,["config"])],8,s1))),256))])]))),256))])):Oe("",!0),D(i)?Oe("",!0):(z(),Q("button",o1,"Loading"))]))}},iv=tP({history:yA("https://shashwat986.github.io/MV-SH-Test/"),routes:[{path:"/",name:"home",component:Id},{path:"/browse",name:"browse",component:l1},{path:"/edit/:id",name:"edit",component:Id}]}),kr=IE(cP),sv=SE();sv.use(XE);kr.use(sv);kr.use(jE);kr.use(iv);kr.use(ZR,{firebaseApp:Vm});kr.mount("#app");
